...
class Map extends React.Component {
    ...
    constructor(props) {
        ...
        this.handleEnableLanesTool = this.handleEnableLanesTool.bind(this);
    }
    ...
    componentDidMount() {
        ...
        Mousetrap.bind('5', this.handleEnableLanesTool);
    ...
    handleEnableLanesTool() {
        console.log("Enable lane tool");
        if (this.renderer) {
            this.renderer.enableLanesTool();
        }
    }
    ...
    handleUpdateAnnotationData(annotationData) {
        ...
        console.log("Map: updated annotation data is dispatching to server");
